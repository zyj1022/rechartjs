  ...
  datasets: [
    {
      ...
      borderColor: ColorAlpha(Colors[0], 0),
      data: Rdom(5, 100, 2000),
      label: 'D0',
      fill: true
    }, {
      backgroundColor: ColorAlpha(Colors[1], 0.5),
      borderColor: ColorAlpha(Colors[1], 0),
      data: Rdom(5, 100, 2000),
      hidden: true,
      label: 'D1',
      fill: false
